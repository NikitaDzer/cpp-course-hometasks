...
template < typename T > class StackPair
{
public :
...
template < typename T > class StackEncoded
{
public :
...
int main()
{
    ...
    {
        StackPair < double > stack;

        stack.push(3.5); assert(stack.top() == 3.5 && stack.min() == 3.5);
        stack.push(1.2); assert(stack.top() == 1.2 && stack.min() == 1.2);
        stack.push(2.8); assert(stack.top() == 2.8 && stack.min() == 1.2);

        stack.pop(); assert(stack.top() == 1.2 && stack.min() == 1.2);
        stack.pop(); assert(stack.top() == 3.5 && stack.min() == 3.5);
        stack.pop();
    }

    {
        StackEncoded < double > stack;
